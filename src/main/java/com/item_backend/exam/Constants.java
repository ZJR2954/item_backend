...
public class Constants {
    ...
    public static Double DIFFICULTY_LEVEL_VERYEASY= 0.1;
    public static Double DIFFICULTY_LEVEL_EASY= 0.3;
    public static Double DIFFICULTY_LEVEL_MEDIUM= 0.5;
    public static Double DIFFICULTY_LEVEL_HARD= 0.7;
    public static Double DIFFICULTY_LEVEL_VERYHARD= 0.9;


    public static double KP_COVERAGE_RATE = 0.5;//知识点覆盖率 占 适应度 比率
    public static double DIFFICULTY_RATE = 0.5;//难度系数  占 适应度比率

    //期望适应度
    public static double EXPAND_ADATPER=0.9;
